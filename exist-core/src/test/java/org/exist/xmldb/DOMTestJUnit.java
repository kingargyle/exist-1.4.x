...
public class DOMTestJUnit {
	...
	private static String baseURI = "xmldb:exist://localhost:8088/xmlrpc"
	...
	public void setUp() throws Exception {
		// Don't worry about closing the server : the shutdown hook will do
		// the job
		initServer();
		...
		XMLResource r = (XMLResource) rootColl.createResource(name,
